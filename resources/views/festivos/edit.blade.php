...
@section('content')
	...
	<h1 class="page-header">Actualizar Festivo</h1>
	...
	{{ Html::ul($errors->all() )}}
		...
		{{ Form::model($festivo, array('action' => array('FestivosController@update', $festivo->FEST_ID), 'method' => 'PUT', 'class' => 'form-vertical')) }}
