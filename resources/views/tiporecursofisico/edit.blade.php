@extends('layout')
@section('title', '/ Editar Tipo de Recurso Físico '.$tipoRecursoFisico->TIRF_ID)
@section('scripts')
    <script>
    </script>
@endsection
...
@section('content')
	...
	<h1 class="page-header">Actualizar Tipo de Recurso Físico</h1>

	@include('partials/errors')

	{{ Form::model($tipoRecursoFisico, array('action' => array('TipoRecursoFisicoController@update', $tipoRecursoFisico->TIRF_ID), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
