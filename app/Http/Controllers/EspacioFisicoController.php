...
class EspacioFisicoController extends Controller
{
	...
	public function index()
	{
		...
		return view('espaciofisico/index', compact('espaciosFisicos'));
	}
	...
	public function create()
	{
		...
		return view('espaciofisico/create', compact(
			'arrTiposPosesiones',
			'arrTiposEspaciosFisicos',
			'arrLocalidades'
			));
	...
	public function store()
	{
		...
		$espacioFisico->TIEF_ID = Input::get('TIEF_ID'); //Relación con TipoEspacioFisico
		...
		return redirect()->to('espaciofisico');
	}
	...
	public function show($ESFI_ID)
	{
		...
		$espacioFisico = EspacioFisico::findOrFail($ESFI_ID);

		// Muestra la vista y pasa el registro
		return view('espaciofisico/show', compact('espacioFisico'));
	}
	...
	public function edit($ESFI_ID)
	{
		...
		return view('espaciofisico/edit', compact(
			'espacioFisico',
			'arrTiposPosesiones',
			'arrTiposEspaciosFisicos',
			'arrLocalidades'
